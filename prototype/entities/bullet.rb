class Bullet
	...
	def sound
		@@sound ||= Gosu::Sample.new($window,Game.media_path('fire.mp3'))
	...
	def point_at_distance(distance)
		#returns coordinates of the point that is between the
		#bullet source and it's target. returned point
		#is as far away from source point as distance
		#tells it to
