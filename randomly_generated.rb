...
class GameWindow < Gosu::Window
	...
	def load_tiles
		...
		@sand = tiles[0]
		@grass = tiles[8]
		@water = Gosu::Image.new(self, media_path('water.png'),{:tileable => true})
	...
	#este es el corazón del programa
	#crea un Perlin en 2d
	#escoge loza por cada localización del mapa
	#contraste cubico hace que se vea mas sharp jeje
	def generate_map
		...
		MAP_WIDTH.times do |x|
			...
			MAP_HEIGHT.times do |y|
				...
				n = contrast.call(n)
				map[x][y] = choose_tile(n) #se escoge el tile
			end
		end
		map
	end
